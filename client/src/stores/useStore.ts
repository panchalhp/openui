...
const DEFAULT_LIST_SECTIONS: ListSection[] = [
  ...
  { id: "oncall-critical", label: "Critical", color: "#EF4444", group: "oncall" },
  { id: "oncall-urgent", label: "Urgent", color: "#F97316", group: "oncall" },
  { id: "oncall-miscellaneous", label: "Miscellaneous", color: "#06B6D4", group: "oncall" },
];
